<?php
    ...
    class VerticalBarChartEstat extends BarChartEstat {
        /**
         * Ratio of empty space beside the bars.
         */
        private $emptyToFullRatio;
         ...
         * @param integer height of the image
         */
        public function VerticalBarChartEstat($width = 600, $height = 300) {
            parent::BarChartEstat($width, $height);

            $this->emptyToFullRatio = 1 / 5;
            $this->plot->setGraphPadding(new Padding(5, 20, 50, -10));
        }
        ...
        protected function printBar() {
            ...
            for ($j = 0; $j < $serieCount; $j++) {
                ...
                for ($i = 0; $i < $pointCount; $i++) {
                    ...
                    // Bar dimensions
                    $xWithMargin = $x - 5 + $columnWidth * $this->emptyToFullRatio;
                    $columnWidthWithMargin = $columnWidth * (1 - $this->emptyToFullRatio * 2);
                    $barWidth = $columnWidthWithMargin / $serieCount;
                    $barOffset = ($barWidth + 10) * $j;
                    $x1 = $xWithMargin + $barOffset;
                    $x2 = $xWithMargin + $barWidth + $barOffset - 3;
    ...
    class VerticalBarChartEstat2 extends BarChartEstat2 {
    /**
     * Ratio of empty space beside the bars.
     */
    private $emptyToFullRatio;
     ...
     * @param integer height of the image
     */
    public function VerticalBarChartEstat2($width = 600, $height = 300) {
        parent::BarChartEstat2($width, $height);

        $this->emptyToFullRatio = 1 / 5;
        $this->plot->setGraphPadding(new Padding(5, 260, 50, -10));
    }
