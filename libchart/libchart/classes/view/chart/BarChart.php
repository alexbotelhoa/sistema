<?php
    ...
    abstract class BarChartEstat extends ChartEstat {
    protected $bound;
    protected $axis;
    protected $hasSeveralSerie;
     ...
     * @param integer height of the image
     */
    protected function BarChartEstat($width, $height) {
        parent::ChartEstat($width, $height);
    ...
    protected function createImage() {
        ...
        // Axis
        imagerectangle($img, $graphArea->x1 - 1, $graphArea->y1 - 0, $graphArea->x1 -0, $graphArea->y2 - 0, $palette->axisColor[0]->getColor($img));
        imagerectangle($img, $graphArea->x1 - 1, $graphArea->y2 - 0, $graphArea->x2 -0, $graphArea->y2 - 0, $palette->axisColor[0]->getColor($img));
    }
    ...
    abstract class BarChartEstat2 extends ChartEstat2 {
    protected $bound;
    protected $axis;
    protected $hasSeveralSerie;
     ...
     * @param integer height of the image
     */
    protected function BarChartEstat2($width, $height) {
        parent::ChartEstat2($width, $height);
