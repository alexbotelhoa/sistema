        ...
        if ($_POST['mes'] == "0" or $_POST['ano'] == "0") {
            ...
            <table border="1" cellpadding="0" cellspacing="0"
                ...
                <tr height="30">
                    ...
                    <td align="center">R$ <?php echo number_format($Tmrr1, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format($Tmrr0, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format(($Tmrr0 - $Tmrr1), 2, ',', '.'); ?></td>
                    <td align="center"><?php if(($Tmrr0 - $Tmrr1) != 0) { echo round((($Tmrr0 - $Tmrr1) * 100) / $Tmrr1, 2);} else {echo round("0",2);} ?> %</td>
                    <td align="center"><a
                ...
                <tr height="30" bgcolor="#f5fcff">
                    ...
                    <td align="center">R$ <?php echo number_format($Tnew1, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format($Tnew0, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format(($Tnew0 - $Tnew1), 2, ',', '.'); ?></td>
                    <td align="center"><?php if(($Tnew0 - $Tnew1) != 0) { echo round((($Tnew0 - $Tnew1) * 100) / $Tnew1, 2);} else {echo round("0",2);} ?> %</td>
                    <td align="center"><a
                ...
                <tr height="30">
                    ...
                    <td align="center">R$ <?php echo number_format($Texpan1, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format($Texpan0, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format($Texpan0 - $Texpan1, 2, ',', '.'); ?></td>
                    <td align="center"><?php if(($Texpan0 - $Texpan1) != 0) { echo round((($Texpan0 - $Texpan1) * 100) / $Texpan1, 2);} else {echo round("0",2);} ?> %</td>
                    <td align="center"><a
                ...
                <tr height="30" bgcolor="#f5fcff">
                    ...
                    <td align="center">R$ <?php echo number_format($Tresur1, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format($Tresur0, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format($Tresur0 - $Tresur1, 2, ',', '.'); ?></td>
                    <td align="center"><?php if(($Tresur0 - $Tresur1) != 0) { echo round((($Tresur0 - $Tresur1) * 100) / $Tresur1, 2);} else {echo round("0",2);} ?> %</td>
                    <td align="center"><a
                ...
                <tr height="30">
                    ...
                    <td align="center">R$ <?php echo number_format($Tcontr1, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format($Tcontr0, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format($Tcontr0 - $Tcontr1, 2, ',', '.'); ?></td>
                    <td align="center"><?php if(($Tcontr0 - $Tcontr1) != 0) { echo round((($Tcontr0 - $Tcontr1) * 100) / $Tcontr1, 2);} else {echo round("0",2);} ?> %</td>
                    <td align="center"><a
                ...
                <tr height="30" bgcolor="#f5fcff">
                    ...
                    <td align="center">R$ <?php echo number_format($Tcance1, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format($Tcance0, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format($Tcance0 - $Tcance1, 2, ',', '.'); ?></td>
                    <td align="center"><?php if(($Tcance0 - $Tcance1) != 0) { echo round((($Tcance0 - $Tcance1) * 100) / $Tcance1, 2);} else {echo round("0",2);} ?> %</td>
                    <td align="center"><a
                ...
                <tr height="30" bgcolor="#f5fcff">
                    ...
                    <td align="center">R$ <?php echo number_format($Tarpu1, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format($Tarpu0, 2, ',', '.'); ?></td>
                    <td align="center">R$ <?php echo number_format($Tarpu0 - $Tarpu1, 2, ',', '.'); ?></td>
                    <td align="center"><?php if(($Tarpu0 - $Tarpu1) != 0) { echo round((($Tarpu0 - $Tarpu1) * 100) / $Tarpu1, 2);} else {echo round("0",2);} ?> %</td>
                    <td align="center"><a
                ...
                <tr height="30" bgcolor="#f5fcff">
                    ...
                    <td align="center"><?php if(($Tchurn0 - $Tchurn1) != 0) {echo number_format($Tchurn1, 2, ',', '.');} else {echo round("0",2);} ?> %</td>
                    <td align="center"><?php if(($Tchurn0 - $Tchurn1) != 0) {echo number_format($Tchurn0, 2, ',', '.');} else {echo round("0",2);} ?> %</td>
                    <td align="center"><?php if(($Tchurn0 - $Tchurn1) != 0) {echo number_format($Tchurn0 - $Tchurn1, 2, ',', '.');} else {echo round("0",2);} ?> %</td>
                    <td align="center"><?php if(($Tchurn0 - $Tchurn1) != 0) {echo round((($Tchurn0 - $Tchurn1) * 100) / $Tchurn1, 2);} else {echo round("0",2);} ?> %</td>
                    <td align="center"><a
...
<!--
                <tr height="30" bgcolor="#f5fcff">
                    ...
                    <td align="center">R$ <?php /*echo number_format($Tltv1, 2, ',', '.'); */?></td>
                    <td align="center">R$ <?php /*echo number_format($Tltv0, 2, ',', '.'); */?></td>
                    <td align="center">R$ <?php /*echo number_format($Tltv0 - $Tltv1, 2, ',', '.'); */?></td>
