<?php
    ...
    class LineChart extends BarChart {
        ...
        public function LineChart($width = 600, $height = 250) {
            ...
            $this->plot->setGraphPadding(new Padding(5, 10, 50, 0));
        }
    ...
    class LineChartEstat extends BarChartEstat {
    /**
     * Creates a new line chart.
     * Line charts allow for XYDataSet and XYSeriesDataSet in order to plot several lines.
     *
     ...
     * @param integer height of the image
     */
    public function LineChartEstat($width = 600, $height = 250) {
    ...
    class LineChartEstat2 extends BarChartEstat2 {
    /**
     * Creates a new line chart.
     * Line charts allow for XYDataSet and XYSeriesDataSet in order to plot several lines.
     *
