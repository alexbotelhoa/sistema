...
include "libchart/libchart/classes/libchart.php";
    ...
    if (isset($_POST['search'])) {
        if ($_POST['mes'] == "0" or $_POST['ano'] == "0") {
            ...
            $Tmrr0=0; $Tnew0=0; $Texpan0=0; $Tresur0=0; $Tcontr0=0; $Tcance0=0;
            $Tmrr1=0; $Tnew1=0; $Texpan1=0; $Tresur1=0; $Tcontr1=0; $Tcance1=0;
            $Tmrr2=0; $Tnew2=0; $Texpan2=0; $Tresur2=0; $Tcontr2=0; $Tcance2=0;
            $Tmrr3=0; $Tnew3=0; $Texpan3=0; $Tresur3=0; $Tcontr3=0; $Tcance3=0;
            $Tmrr4=0; $Tnew4=0; $Texpan4=0; $Tresur4=0; $Tcontr4=0; $Tcance4=0;
            $Tmrr5=0; $Tnew5=0; $Texpan5=0; $Tresur5=0; $Tcontr5=0; $Tcance5=0;
            $Tmrr6=0; $Tnew6=0; $Texpan6=0; $Tresur6=0; $Tcontr6=0; $Tcance6=0;

            while ($dados = mysqli_fetch_array($consulta)) {
                $mes[7]=0;$mes[6]=0;$mes[5]=0;$mes[4]=0;$mes[3]=0;$mes[2]=0;$mes[1]=0;$mes[0]=0;
                ...
                if ($mes[0]!=0 and $mes[1]==0 and $dados['contador']>1) {$Tresur0 = $Tresur0 + $mes[0];$rs++;}
                ...
                if ($mes[1]!=0 and $mes[2]==0 and $dados['contador']>($rs+1)) {$Tresur1 = $Tresur1 + $mes[1];$rs++;}
                if ($mes[1]!=0 and $mes[2]!=0 and $mes[1]<$mes[2]) {$Tcontr1 = $Tcontr1 + ($mes[2]-$mes[1]);}
                if ($mes[1]==0 and $mes[2]!=0) {$Tcance1 = $Tcance1 + $mes[2];}

                if ($mes[2]!=0) {$Tmrr2 = $Tmrr2 + $mes[2];}
                if ($mes[2]!=0 and $dados['contador']==1) {$Tnew2 = $Tnew2 + $mes[2];}
                if ($mes[2]!=0 and $mes[3]!=0 and $mes[2]>$mes[3]) {$Texpan2 = $Texpan2 + ($mes[2]-$mes[3]);}
                if ($mes[2]!=0 and $mes[3]==0 and $dados['contador']>($rs+1)) {$Tresur2 = $Tresur2 + $mes[2];$rs++;}
                if ($mes[2]!=0 and $mes[3]!=0 and $mes[2]<$mes[3]) {$Tcontr2 = $Tcontr2 + ($mes[3]-$mes[2]);}
                if ($mes[2]==0 and $mes[3]!=0) {$Tcance2 = $Tcance2 + $mes[3];}

                if ($mes[3]!=0) {$Tmrr3 = $Tmrr3 + $mes[3];}
                if ($mes[3]!=0 and $dados['contador']==1) {$Tnew3 = $Tnew3 + $mes[3];}
                if ($mes[3]!=0 and $mes[4]!=0 and $mes[3]>$mes[4]) {$Texpan3 = $Texpan3 + ($mes[3]-$mes[4]);}
                if ($mes[3]!=0 and $mes[4]==0 and $dados['contador']>($rs+1)) {$Tresur3 = $Tresur3 + $mes[3];$rs++;}
                if ($mes[3]!=0 and $mes[4]!=0 and $mes[3]<$mes[4]) {$Tcontr3 = $Tcontr3 + ($mes[4]-$mes[3]);}
                if ($mes[3]==0 and $mes[4]!=0) {$Tcance3 = $Tcance3 + $mes[4];}

                if ($mes[4]!=0) {$Tmrr4 = $Tmrr4 + $mes[4];}
                if ($mes[4]!=0 and $dados['contador']==1) {$Tnew4 = $Tnew4 + $mes[4];}
                if ($mes[4]!=0 and $mes[5]!=0 and $mes[4]>$mes[5]) {$Texpan4 = $Texpan4 + ($mes[4]-$mes[5]);}
                if ($mes[4]!=0 and $mes[5]==0 and $dados['contador']>($rs+1)) {$Tresur4 = $Tresur4 + $mes[4];$rs++;}
                if ($mes[4]!=0 and $mes[5]!=0 and $mes[4]<$mes[5]) {$Tcontr4 = $Tcontr4 + ($mes[5]-$mes[4]);}
                if ($mes[4]==0 and $mes[5]!=0) {$Tcance4 = $Tcance4 + $mes[5];}

                if ($mes[5]!=0) {$Tmrr5 = $Tmrr5 + $mes[5];}
                if ($mes[5]!=0 and $dados['contador']==1) {$Tnew5 = $Tnew5 + $mes[5];}
                if ($mes[5]!=0 and $mes[6]!=0 and $mes[5]>$mes[6]) {$Texpan5 = $Texpan5 + ($mes[5]-$mes[6]);}
                if ($mes[5]!=0 and $mes[6]==0 and $dados['contador']>($rs+1)) {$Tresur5 = $Tresur5 + $mes[5];$rs++;}
                if ($mes[5]!=0 and $mes[6]!=0 and $mes[5]<$mes[6]) {$Tcontr5 = $Tcontr5 + ($mes[6]-$mes[5]);}
                if ($mes[5]==0 and $mes[6]!=0) {$Tcance5 = $Tcance5 + $mes[6];}

                if ($mes[6]!=0) {$Tmrr6 = $Tmrr6 + $mes[6];}
                if ($mes[6]!=0 and $dados['contador']==1) {$Tnew6 = $Tnew6 + $mes[6];}
                if ($mes[6]!=0 and $mes[7]!=0 and $mes[6]>$mes[7]) {$Texpan6 = $Texpan6 + ($mes[6]-$mes[7]);}
                if ($mes[6]!=0 and $mes[7]==0 and $dados['contador']>($rs+1)) {$Tresur6 = $Tresur6 + $mes[6];$rs++;}
                if ($mes[6]!=0 and $mes[7]!=0 and $mes[6]<$mes[7]) {$Tcontr6 = $Tcontr6 + ($mes[7]-$mes[6]);}
                if ($mes[6]==0 and $mes[7]!=0) {$Tcance6 = $Tcance6 + $mes[7];}
