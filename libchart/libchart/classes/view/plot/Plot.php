<?php
    ...
    class Plot {
        ...
        protected $graphPaddingAnalitico;
        ...
        public function Plot($width, $height) {
            ...
            // Default layout
            $this->outputArea = new Rectangle(70, 0, $width + 5, $height - 1);
    ...
    class PlotEstat {
         ...
         * @param integer height of the image
         */
        public function PlotEstat($width, $height) {
            $this->width = $width;
            $this->height = $height;
            ...
            // Default layout
            $this->outputArea = new Rectangle(70, 0, $width + 200, $height - 0);
            $this->outerPadding = new Padding(5);
            $this->titleHeight = 26;
            $this->titlePadding = new Padding(5);
            $this->hasCaption = false;
        ...
        private function computeGraphArea() {
            ...
            $graphArea = null;
            if ($this->hasCaption) {
                $graphUnpaddedRight = $this->imageArea->x1 + 5 + ($this->imageArea->x2 - $this->imageArea->x1) * $this->graphCaptionRatio
                    + $this->graphPadding->left + $this->graphPadding->right;
                $graphArea = new Rectangle(
                    $this->imageArea->x1 + 0,
                    $titleUnpaddedBottom - 0,
                    $graphUnpaddedRight + 10,
                    $this->imageArea->y2 + 10
                );
            } else {
                $graphArea = new Rectangle(
                    $this->imageArea->x1,
         ...
         */
        public function printTitle() {
            $yCenter = $this->titleArea->y1 + 0 + ($this->titleArea->y2 - $this->titleArea->y1) / 2;
            $this->text->printCentered($this->img, $yCenter, $this->textColor, $this->title, $this->text->fontCondensedBold);
        }
     ...
     * @param integer height of the image
     */
    public function PlotEstat2($width, $height) {
        $this->width = $width;
        $this->height = $height;
        ...
        // Default layout
        $this->outputArea = new Rectangle(70, 0, $width + 240, $height - 0);
        $this->outerPadding = new Padding(5);
        $this->titleHeight = 26;
        $this->titlePadding = new Padding(5);
        $this->hasCaption = false;
